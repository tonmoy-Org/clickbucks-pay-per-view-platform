    ...
    <div class="table-content">
        <div class="row">
            <div class="d-flex justify-content-end mb-3">
                <a href="{{route('advertiser.ticket') }}" class="btn btn--base">@lang('My Support Ticket')</a>
            </div>
            <div class="col-lg-12">
                <div class="dashboard-card-wrap mt-0">
                    <form action="{{route('advertiser.ticket.store')}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="priority" class="form-select select" required>
                            ...
                            <div class="col-lg-12">
                                <div class="attachment_wrapper mb-4">
                                    <div class="form-group profile mb-15">
                                        ...
                                        <p>@lang('Max 5 files can be uploaded'). @lang('Maximum upload size
                                            is') {{ ini_get('upload_max_filesize') }}</p>
                            ...
                            <div class="col-sm-12 text-end">
                                <button type="submit" class="btn btn--base ms-2" id="recaptcha">
                                    @lang('Submit')
                                </button>
                            </div>
                        </div>
