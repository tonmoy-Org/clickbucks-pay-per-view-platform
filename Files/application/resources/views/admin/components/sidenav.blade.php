<div class="sidebar">
    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.advertisers.*')}}">
                    <a href="{{route('admin.advertisers.active')}}" class="nav-link position-relative">
                        <i class="menu-icon las la-user"></i>
                        <span class="menu-title">@lang('Manage Advertisers')</span>
                        @if($bannedAdvertisersCount > 0 || $emailUnverifiedAdvertisersCount > 0 ||
                        $mobileUnverifiedAdvertisersCount > 0)
                        <div class="blob white"></div>
                        @endif
                    </a>
                </li>
                ...
                <li class="sidebar__menu-header">@lang('PTC')</li>
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.ptc*')}}">
                    <a href="{{route('admin.ptc.index')}}" class="nav-link"
                        data-default-url="{{ route('admin.ptc.index') }}">
                        <i class="menu-icon las la-mouse-pointer"></i>
                        <span class="menu-title">@lang('PPV Ads') </span>
                    </a>
                </li>
        ...
        <li class="sidebar-menu-item {{menuActive('admin.withdraw.advertiser.pending')}}">
            <a href="{{route('admin.withdraw.advertiser.pending')}}" class="nav-link ">
                <i class="menu-icon las la la-credit-card"></i>
                <span class="menu-title">@lang('Advertiser Withdrawals')</span>
                @if(0 < $pendingadvertiserWithdrawCount)
                <div class="blob white"> </div>
                @endif
            </a>
        </li>
...
<li class="sidebar-menu-item {{menuActive('admin.advertiser.ticket.*')}}">
    <a href="{{route('admin.advertiser.ticket.pending')}}" class="nav-link position-relative">
        <i class="menu-icon las la la-life-ring"></i>
        <span class="menu-title">@lang('Advertiser Support')</span>
        @if(0 < $advertiserpendingTicketCount) <div class="blob white">
            </div>
            @endif
    </a>
</li>
