...
<div class="row gy-4">
    ...
    <div class="col-xl-6">
        <div class="row gy-4">
            ...
            <div class="col-sm-6">
                <a href="{{route('admin.ptc.index')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Total Ads')</h6>
                                    <h3 class="m-b-0">{{$ptc['totalPtc']}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon fas fa-ad"></i>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6">
                <a href="{{route('admin.ptc.pending')}}">
                    <div class="card prod-p-card background-pattern">
                        <div class="card-body">
                            <div class="row align-items-center m-b-0">
                                <div class="col">
                                    <h6 class="m-b-5">@lang('Pending Ads')</h6>
                                    <h3 class="m-b-0">{{$ptc['totalPending']}}</h3>
                                </div>
                                <div class="col-auto">
                                    <i class="dashboard-widget__icon fas fa-ad"></i>
                                </div>
