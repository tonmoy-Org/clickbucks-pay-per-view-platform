...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $val['name'] = authAdvertiser()->username;
        $val['description'] = "Payment By Razorpay";
        $val['image'] = getImage(getFilePath('logoIcon') .'/logo.png');
        $val['prefill.name'] = authAdvertiser()->firstname . ' ' . authAdvertiser()->lastname;
        $val['prefill.email'] = authAdvertiser()->email;
        $val['prefill.contact'] = authAdvertiser()->mobile;
