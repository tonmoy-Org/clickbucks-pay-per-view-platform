...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <form action="{{ route('admin.withdraw.advertiser.method.update', $method->id) }}" method="POST"
...
<a href="{{ route('admin.withdraw.advertiser.method.index') }}" class="btn btn-sm btn--primary">@lang('Back')
</a>
@endpush
