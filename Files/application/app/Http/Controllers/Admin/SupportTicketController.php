...
class SupportTicketController extends Controller
{
    ...
    public function answeredTicket()
    {
     ...
     public function advertiserPendingTicket()
     {
         $pageTitle = 'Pending Tickets';
         $items = SupportTicket::where('advertiser_id', '!=', 0)->where('user_id','=',0)->whereIn('status', [0,2])->orderBy('id','desc')->with('advertiser')->paginate(getPaginate());
         return view('admin.advertisers.support.tickets', compact('items', 'pageTitle'));
     }

     public function advertiserClosedTicket()
     {
         $pageTitle = 'Closed Tickets';
         $items = SupportTicket::where('advertiser_id', '!=', 0)->where('user_id','=',0)->where('status',3)->orderBy('id','desc')->with('advertiser')->paginate(getPaginate());
         return view('admin.advertisers.support.tickets', compact('items', 'pageTitle'));
     }

     public function advertiserAnsweredTicket()
     {
         $pageTitle = 'Answered Tickets';
         $items = SupportTicket::where('advertiser_id', '!=', 0)->where('user_id','=',0)->orderBy('id','desc')->with('advertiser')->where('status',1)->paginate(getPaginate());
         return view('admin.advertisers.support.tickets', compact('items', 'pageTitle'));
     }
     public function advertiserTickets()
     {
         $pageTitle = 'Support Tickets';
         $items = SupportTicket::where('advertiser_id', '!=', 0)->where('user_id','=',0)->orderBy('id','desc')->with('advertiser')->paginate(getPaginate());
         return view('admin.advertisers.support.tickets', compact('items', 'pageTitle'));
     }
