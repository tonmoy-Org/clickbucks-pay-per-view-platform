...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <form action="{{route('advertiser.deposit.insert')}}" method="post">
                @csrf
                    ...
                    <div class="form-body">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-select select" name="gateway" required>
                                ...
                                <option value="balance">@lang('Account Balance') {{ $general->cur_sym }}{{showAmount(authAdvertiser()->balance) }}</option>
