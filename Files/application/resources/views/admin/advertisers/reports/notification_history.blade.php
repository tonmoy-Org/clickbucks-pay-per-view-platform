                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    @if($log->advertiser)
                                    <a href="{{ route('admin.advertisers.detail', $log->advertiser_id) }}">{{ @$log->advertiser->fullname
                                        }}</a>
                                    @else
                                ...
                                <td>
                                    <button title="@lang('Details')" class="btn btn-sm btn--primary notifyDetail"
                                        ...
                                        'email') data-message="{{ route('admin.advertiser.report.email.details',$log->id)}}" @else
